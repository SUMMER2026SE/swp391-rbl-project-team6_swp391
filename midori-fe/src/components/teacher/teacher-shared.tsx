  ...
  return (
    <div className="rounded-xl border border-green-200 bg-green-50/60 dark:border-green-800 dark:bg-green-950/30 px-4 py-3 text-sm text-green-800 dark:text-green-200 shadow-sm backdrop-blur-sm">
      <div className="flex items-start gap-3">
        <div className="grid h-8 w-8 shrink-0 place-items-center rounded-full bg-green-500 text-white text-xs font-bold">
          &#10003;
        </div>
        ...
        {onDismiss && (
          <button
            onClick={onDismiss}
            className="shrink-0 rounded-md p-1 text-green-600 hover:bg-green-100 dark:text-green-400 dark:hover:bg-green-900 transition"
          >
            <X className="h-4 w-4" />
          </button>
        )}
