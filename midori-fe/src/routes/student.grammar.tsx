  ...
  return (
    ...
    >
      ...
      >
        {/* Modal Header */}
        <div
          className={`bg-gradient-to-br ${levelGradients[item.level]} px-6 py-5 sticky top-0 z-10`}
        >
        ...
        <div className="p-6 space-y-5">
          ...
          {item.structure && (
            <div className="p-4 rounded-xl bg-purple-50 dark:bg-purple-950/20 border border-purple-100 dark:border-purple-900/30">
              <div className="text-[10px] font-bold text-purple-500 uppercase tracking-wider mb-1.5">
                Formation / Structure
              </div>
              <div className="font-display font-black text-purple-700 dark:text-purple-300 text-base">
                {item.structure}
              </div>
            </div>
          )}
          ...
          {item.pattern && (
            <div className="p-4 rounded-xl bg-amber-50 dark:bg-amber-950/20 border border-amber-100 dark:border-amber-900/30">
              <div className="text-[10px] font-bold text-amber-500 uppercase tracking-wider mb-1.5">
                Pattern
              </div>
              <p className="text-xs leading-relaxed text-amber-700 dark:text-amber-300 whitespace-pre-line">
                {item.pattern}
              </p>
            </div>
          )}
...
function GrammarPage() {
  ...
  const toggleComplete = async (id: string) => {
    ...
    console.log(
      "[GrammarProgress] toggleComplete clicked",
      id,
      "currentlyCompleted:",
                  ...
                  <div className="py-16 text-center">
                    ...
                    <p className="text-sm text-muted-foreground">
                      {statusFilter === "bookmarked"
                        ? "No bookmarked grammar found."
                        : statusFilter === "completed"
                          ? "No completed grammar found."
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-3 min-w-0">
                          <div
                            className={`w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0 bg-gradient-to-br ${levelGradients[g.level]}`}
                          >
                            <GraduationCap className="w-4 h-4 text-white" />
                          </div>
                          <div className="min-w-0">
                            <div className="font-display font-black text-sm text-slate-800 dark:text-white truncate">
                              {g.title}
                            </div>
                        ...
                        <div>
                          <span
                            className={`px-2 py-0.5 rounded-full text-[10px] font-bold ${levelColors[g.level]}`}
                          >
                            {g.level}
                          </span>
                        </div>
                        ...
                        >
                          ...
                          >
                            <CheckCircle2
                              className={`w-3.5 h-3.5 ${isComp ? "fill-green-400" : ""}`}
                            />
                          </button>
                          <button
