  ...
  return (
    <AuthShell title="Password reset!" subtitle="Your password has been updated successfully.">
      <div className="text-center py-4">
        ...
        <Link to="/login" className="inline-block w-full px-4 py-3 rounded-xl bg-gradient-hero text-white font-semibold shadow-md hover:shadow-lg transition">Back to sign in</Link>
      </div>
    </AuthShell>
  );
}