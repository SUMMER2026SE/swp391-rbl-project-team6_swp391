...
export const getMockDataCount = () => ({
  ...
  shadowing: shadowingTopics.length,
});
...
export const getMockDataByLevel = (level: JLPTLevel) => ({
  ...
  shadowing: shadowingTopics.filter((item) => item.jlptLevel === level),
});
