...
Nice to meet you.`,
    ...
    grammarPoints: [
      {
        grammar: "~です",
        explanation: "Polite sentence ending for stating facts",
        example: "十八歳です",
        exampleTranslation: "I am 18 years old",
      },
      {
        grammar: "~ています",
        explanation: "Present continuous action",
        example: "日本語を勉强しています",
      ...
      },
      {
        ...
        example: "よろしくお願いいします",
        exampleTranslation: "Please (treat me well)",
      },
    ],
    comprehensionQuestions: [
      {
        ...
        options: ["読書", "切手の収集", "散歩", "料理"],
        correctAnswer: 1,
        explanation: "趣味は切手の収集です。",
      },
      {
        id: "rq-001-2",
        question: "田中さんはどこに出身ですか？",
        options: ["大阪", "京都", "東京都", "广州"],
        correctAnswer: 2,
        explanation: "東京都の出身です。",
      },
      {
        id: "rq-001-3",
        question: "週末に田中さんは何をしますか？",
        options: ["一人で勉強する", "友達と集まる", "家族と旅行する", "働く"],
        correctAnswer: 1,
        explanation: "週末に友達と集まります。",
      },
    ],
    jlptLevel: "N5",
...
School is until 6. After coming home, I do homework.`,
    ...
    grammarPoints: [
      {
        grammar: "~に(時間)",
        explanation: "At a specific time point",
        example: "七時に起きます",
        exampleTranslation: "I wake up at 7",
      },
      {
        grammar: "~に行きます",
      ...
      },
      {
        ...
        example: "帰る後、宿題をします",
        exampleTranslation: "After returning, I do homework",
      },
    ],
    comprehensionQuestions: [
      {
        id: "rq-002-1",
        question: "授業はいつ始まりますか？",
        options: ["七時", "八時", "九時", "六時"],
        correctAnswer: 2,
      ...
      {
        id: "rq-002-2",
        question: "火曜日に何がありますか？",
        options: ["数学", "日本語", "英語", "理科"],
        correctAnswer: 1,
        explanation: "火曜日は日本語のClaireがあります。",
      },
      {
        id: "rq-002-3",
        question: "放課後干什么？",
        options: ["回家", "部活", "旅行", "買い物"],
        correctAnswer: 1,
        explanation: "放課後は部活があります。",
      },
    ],
    jlptLevel: "N5",
...
I think family is the most important thing.`,
    ...
    grammarPoints: [
      {
        grammar: "~がいます",
        explanation: "There exists (people/animals)",
        example: "父と母と妹がいます",
        exampleTranslation: "I have a father, mother, and sister",
      },
      {
        grammar: "~で一番~",
        explanation: "The most ~ in...",
        example: "家族が一番大切",
      ...
      },
      {
        ...
        example: "家族が一番大切だと思います",
        exampleTranslation: "I think family is the most important",
      },
    ],
    comprehensionQuestions: [
      {
        id: "rq-003-1",
        question: "家族の構成は几人ですか？",
        options: ["三人", "四人", "五人", "六人"],
        correctAnswer: 1,
        explanation: "私の家族は四人です。",
      },
      {
        id: "rq-003-2",
        question: "父は何をしていますか？",
        options: ["教師", "社長", "医者", "弁護士"],
        correctAnswer: 1,
        explanation: "父は会社の社长です。",
      },
      {
        id: "rq-003-3",
        question: "妹的特点是什么？",
        options: ["歌が上手", "足が速い", "料理が得意", "絵が上手"],
        correctAnswer: 1,
        explanation: "足が速いです。",
      },
    ],
    ...
    grammarPoints: [
      {
        ...
        example: "起きてから、ラジオ体操をします",
        exampleTranslation: "After waking up, I do radio exercises",
      },
      {
        grammar: "~まで",
        explanation: "Until/to (a place)",
        example: "会社まで電車で三十分",
        exampleTranslation: "30 minutes by train to the company",
      },
      {
        grammar: "~てみる",
        explanation: "Try doing...",
        example: "軽く运动してみる",
        exampleTranslation: "Try exercising lightly",
      },
    ],
    comprehensionQuestions: [
      {
        id: "rq-004-1",
        question: "何時に家を出ますか？",
        options: ["六時半", "七時", "八時", "九時"],
        correctAnswer: 2,
        explanation: "八時に家を出ます。",
      },
      {
        id: "rq-004-2",
        question: "会社まで何でいきますか？",
        options: ["バス", "電車", "車", "歩いて"],
        correctAnswer: 1,
        explanation: "電車で三十分かかります。",
      },
      {
        id: "rq-004-3",
        question: "晚上干什么？",
        options: ["勉强", "運動", "買い物", "fera"],
        correctAnswer: 1,
        explanation: "晚上軽く运动して、十一時に寝ます。",
      },
    ],
    jlptLevel: "N5",
...
I spent 5,000 yen in total.`,
    ...
    grammarPoints: [
      {
        grammar: "~円と~円",
        explanation: "Stating prices",
        example: "三万円でした",
        exampleTranslation: "It was 30,000 yen",
      },
      {
        grammar: "~で~も",
        explanation: "Also...at (place)",
        example: "デパートで靴を買いました",
        exampleTranslation: "Bought shoes at the department store",
      },
      {
        grammar: "全部で~",
        explanation: "In total...",
        example: "全部で五千円",
        exampleTranslation: "5,000 yen in total",
      },
    ],
    comprehensionQuestions: [
      {
        id: "rq-005-1",
        question: "靴はいくらでしたか？",
        options: ["五万円", "三万円", "一万円", "三千円"],
        correctAnswer: 1,
        explanation: "三万円でした。",
      },
      {
        id: "rq-005-2",
        question: "全部でいくら使いましたか？",
        options: ["三万円", "一万円", "五千円", "八千円"],
        correctAnswer: 2,
        explanation: "全部で五千円使いました。",
      },
      {
        id: "rq-005-3",
        question: "谁と買い物に行きましたか？",
        options: ["家族と", "友達と", "一人で", "先生と"],
        correctAnswer: 1,
        explanation: "今日は友達と一緒にShoppingに行きました。",
      },
    ],
    jlptLevel: "N5",
...
The food at this restaurant is delicious, I want to come again next time too.`,
    ...
    grammarPoints: [
      {
        grammar: "~と~",
        explanation: "With (person)",
        example: "友達とレストランに行きます",
        exampleTranslation: "I go to a restaurant with my friend",
      },
      {
        grammar: "~にします",
        explanation: "I'll have/~ will be",
        example: "何にしますか",
        exampleTranslation: "What will you have?",
      },
      {
        grammar: "~たいです",
        explanation: "Want to (verb)",
        example: "来たいです",
        exampleTranslation: "I want to come",
      },
    ],
    comprehensionQuestions: [
      {
        id: "rq-006-1",
        question: "著者は何を注文しましたか？",
        options: ["ピザ", "意大利面", "カレー", "ラーメン"],
        correctAnswer: 1,
        explanation: "Watashi wa supageti wo chuumon shimashita.",
      },
      {
        id: "rq-006-2",
        question: "友達は何を注文しましたか？",
        options: ["意大利面", "披萨", "カレー", "定食"],
        correctAnswer: 1,
        explanation: "Tomodachi wa pizza wo chuumon shimashita.",
      },
      {
        id: "rq-006-3",
        question: "著者は还想来这里吗？",
        options: ["不想", "无所谓", "很想", "不知道"],
        correctAnswer: 2,
        explanation: "下次还想来。(Raigetsu moikitai desu.)",
      },
    ],
    jlptLevel: "N5",
...
It seems it will become cooler in the latter half of the week.`,
    ...
    grammarPoints: [
      {
        grammar: "~そうです",
        explanation: "I heard that~/apparently",
        example: "凉しくなるそうです",
        exampleTranslation: "I heard it will become cool",
      },
      {
        grammar: "~見込みです",
        explanation: "Expected to...",
        example: "雨が降る見込みです",
        exampleTranslation: "Rain is expected",
      },
      {
        grammar: "~度です",
        explanation: "Degree (temperature)",
        example: "二十八度です",
        exampleTranslation: "It is 28 degrees",
      },
    ],
    comprehensionQuestions: [
      {
      ...
      },
      {
        id: "rq-007-2",
        question: "最高気温は喉度ですか？",
        options: ["十八度", "二十八度", "三十八度", "八度"],
        correctAnswer: 1,
        explanation: "最高気温は二十八度です。",
      },
      {
        id: "rq-007-3",
        question: "明後日の天気はどうですか？",
        options: ["晴れ", "雪", "雨", "曇り"],
        correctAnswer: 2,
        explanation: "明日は雨が降る見込みです。",
      },
    ],
    jlptLevel: "N5",
...
On the third day, I will go shopping and explore local restaurants in Osaka.`,
    ...
    grammarPoints: [
      {
        grammar: "~つもりです",
        explanation: "Intend to~/planning to~",
        example: "旅行に行くつもりです",
        exampleTranslation: "I plan to go on a trip",
      },
      {
        grammar: "~予定です",
        explanation: "Scheduled to~/planned to~",
        example: "新幹線で行く予定です",
        exampleTranslation: "I am scheduled to go by Shinkansen",
      },
      {
        grammar: "~也很好",
        explanation: "Can also~/might also~",
        example: "飞机也可以",
        exampleTranslation: "Plane might work too",
      },
    ],
    comprehensionQuestions: [
      {
      ...
      },
      {
        ...
        options: ["二日", "三日", "四日", "五日"],
        correctAnswer: 1,
        explanation: "三日間の旅程を計画しています。",
      },
      {
        id: "rq-008-3",
        question: "初日に去哪里？",
        options: ["奈良", "大阪", "清水寺", "東京"],
        correctAnswer: 2,
        explanation: "初日は清水寺を訪れます。",
      },
    ],
    jlptLevel: "N5",
    ...
    grammarPoints: [
      {
        ...
        example: "寿司と天ぷらが特に得意です",
        exampleTranslation: "I'm especially good at sushi and tempura",
      },
      {
        grammar: "~を通じて",
        explanation: "Through~/via~",
        example: "趣味を通じて友達を作った",
        exampleTranslation: "Made friends through hobbies",
      },
      {
        grammar: "~も~です",
        explanation: "~also is~",
        example: "料理も好きです",
        exampleTranslation: "I also like cooking",
      },
    ],
    comprehensionQuestions: [
      {
        id: "rq-009-1",
        question: "著者の趣味は何ですか？",
        options: ["読書と運動", "摄影と料理", "音楽と絵", "旅行と购物"],
        correctAnswer: 1,
        explanation: "私の趣味は摄影とCookです。",
      },
      {
        id: "rq-009-2",
        question: "周末做什么？",
        options: ["在家睡觉", "带着相机去公园拍照", "去旅行", "打工"],
        correctAnswer: 1,
        explanation: "周末，我喜欢带着相机去公园拍照。",
      },
      {
        id: "rq-009-3",
        question: "著者は何が得意ですか？",
        options: ["拉面和饺子", "寿司和天妇罗", "咖喱和炒饭", "汉堡和薯条"],
        correctAnswer: 1,
        explanation: "寿司と天ぷらが特に得意です。",
      },
    ],
    jlptLevel: "N5",
...
I'm busy, but the work is interesting.`,
    vocabulary: [
      { word: "IT会社", reading: "アイティかいしゃ", meaning: "IT company", partOfSpeech: "noun" },
      {
        word: "出社",
        reading: "しゅっしゃ",
        meaning: "arrival at office",
        partOfSpeech: "noun/verb",
      },
      {
        word: "退社",
        reading: "たいしゃ",
        meaning: "leaving the office",
        partOfSpeech: "noun/verb",
      },
    ...
    grammarPoints: [
      {
        grammar: "~ています",
        explanation: "Currently doing~ (progressive)",
        example: "新しい 프로젝트를 진행 중입니다",
        exampleTranslation: "I am currently working on a new project",
      },
      {
        grammar: "~ですが、~",
        explanation: "~but~/although~",
        example: "忙しいですが、面白いです",
        exampleTranslation: "I'm busy, but it's interesting",
      },
      {
        grammar: "~を使って",
        explanation: "Using~",
        example: "日本語を使って仕事をします",
        exampleTranslation: "I work using Japanese",
      },
    ],
    comprehensionQuestions: [
      {
        id: "rq-010-1",
        question: "著者はどこでしていますか？",
        options: ["学校", "IT会社", "医院", "银行"],
        correctAnswer: 1,
        explanation: "私はIT 회사에서 일합니다。",
      },
      {
        id: "rq-010-2",
        question: "主な業務は何ですか？",
        options: ["翻訳", "営業", "程序开发", "设计"],
        correctAnswer: 2,
        explanation: "主な業務はプログラム开发です。",
      },
      {
        id: "rq-010-3",
        question: "今何をしていますか？",
        options: ["旅游", "学习", "新しい 프로젝트를 진행 중", "休息"],
        correctAnswer: 2,
        explanation: "今は新しい 프로젝트를 진행 중입니다。",
      },
    ],
    jlptLevel: "N5",
...
On weekends, I sometimes ride my bike to the supermarket.`,
    ...
    grammarPoints: [
      {
        grammar: "~に~ます",
        explanation: "Taking~ (transport)",
        example: "電車に乗ります",
        exampleTranslation: "I take the train",
      },
      {
        grammar: "~そうな時",
        explanation: "When seems like~",
        example: "遅刻しそうな時",
        exampleTranslation: "When it looks like I'll be late",
      },
      {
        grammar: "~と~ます",
        explanation: "If/When~ then~",
        example: "快速に乗ると三十分で着きます",
        exampleTranslation: "If you take the express, you arrive in 30 minutes",
      },
    ],
    comprehensionQuestions: [
      {
        id: "rq-011-1",
        question: "著者は每天都怎么上班？",
        options: ["开车", "骑车", "坐電車", "走路"],
        correctAnswer: 2,
        explanation: "私は每天都坐電車上班。",
      },
      {
        id: "rq-011-2",
        question: "家から駅まで多长时间？",
        options: ["十分钟", "五分钟", "十五分钟", "二十分钟"],
        correctAnswer: 1,
        explanation: "家から駅まで歩いて五分钟です。",
      },
      {
        id: "rq-011-3",
        question: "遅刻しそうな時は怎么做？",
        options: ["早起きする", "タクシーを利用", "休む", "打电话"],
        correctAnswer: 1,
        explanation: "遅刻しそうな時は、タクシーを利用します。",
      },
    ],
    jlptLevel: "N5",
...
On weekends, I study Japanese or meet with friends.`,
    ...
    grammarPoints: [
      {
        grammar: "~は~です",
        explanation: "As for~ it is~",
        example: "時間管理は重要です",
        exampleTranslation: "Time management is important",
      },
      {
        grammar: "~から~まで",
        explanation: "From~ to~",
        example: "一時から二時まで",
        exampleTranslation: "From 1 to 2",
      },
      {
        grammar: "~か~",
        explanation: "~or~",
        example: "勉强するか友達と集まる",
        exampleTranslation: "Study or meet with friends",
      },
    ],
    comprehensionQuestions: [
      {
        id: "rq-012-1",
        question: "著者は何時に起きますか？",
        options: ["六時", "六時半", "七時", "五時半"],
        correctAnswer: 1,
        explanation: "每天早上六点半起床。",
      },
      {
        id: "rq-012-2",
        question: "午休时间是几点到几点？",
        options: ["十二時から一時", "一時方から二時", "二時から三時", "十一時から十二時"],
        correctAnswer: 1,
        explanation: "午休时间是一点到两点。",
      },
      {
        id: "rq-012-3",
        question: "下班后去做什么？",
        options: ["回家", "去健身房锻炼", "图书馆", "购物"],
        correctAnswer: 1,
        explanation: "下班后去健身房锻炼。",
      },
    ],
    jlptLevel: "N5",
...
I don't stay up late, and maintain a regular lifestyle.`,
    ...
    grammarPoints: [
      {
        grammar: "~のために",
        explanation: "For the sake of~/for~",
        example: "健康のために",
        exampleTranslation: "For health",
      },
      {
        grammar: "~ことが~",
        explanation: "It is~ to~ (evaluating actions)",
        example: "十分な睡觉也很重要",
        exampleTranslation: "Getting enough sleep is also important",
      },
      {
        grammar: "~を~",
        explanation: "~and~ (listing)",
        example: "野菜と果物を多く食べます",
        exampleTranslation: "I eat lots of vegetables and fruits",
      },
    ],
    comprehensionQuestions: [
      {
...
From July to August there are firework displays and festivals.`,
    vocabulary: [
      ...
      { word: "参拜", reading: "さんぱい", meaning: "worship/visit", partOfSpeech: "noun/verb" },
      {
        word: "女儿节",
        reading: "ひな祭り",
        meaning: "Girls' Day/Doll Festival",
        partOfSpeech: "noun",
      },
      { word: "人偶", reading: "ひなにんぎょう", meaning: "doll", partOfSpeech: "noun" },
      {
        word: "男孩节",
        reading: "こどもの日",
        meaning: "Children's Day/Boys' Day",
        partOfSpeech: "noun",
      },
    ...
    grammarPoints: [
      {
        grammar: "~には~が~",
        explanation: "In~ there is~",
        example: "日本には节日があります",
        exampleTranslation: "In Japan there are festivals",
      },
      {
        grammar: "~の家庭は~",
        explanation: "Families with~",
        example: "娘の家庭は人形を飾ります",
        exampleTranslation: "Families with daughters display dolls",
      },
      {
        grammar: "~から~まで",
        explanation: "From~ to~",
        example: "七月者から八月まで",
        exampleTranslation: "From July to August",
      },
    ],
    comprehensionQuestions: [
      {
        id: "rq-014-1",
        question: "一月一日人们做什么？",
        options: ["看烟火", "去神社参拜", "挂鲤鱼旗", "摆放人偶"],
        correctAnswer: 1,
        explanation: "人们会去神社参拜。",
      },
      {
        id: "rq-014-2",
        question: "三月三日是什么节日？",
        options: ["新年", "女儿节", "男孩节", "孟兰盆节"],
        correctAnswer: 1,
        explanation: "三月三是女孩节。",
      },
      {
        ...
        options: ["一月", "三月", "五月", "七月"],
        correctAnswer: 2,
        explanation: "五月五日是男孩节，有儿子的家庭会挂鲤鱼旗。",
      },
    ],
    jlptLevel: "N5",
...
On Sunday evenings, I prepare for the new week.`,
    ...
    grammarPoints: [
      {
        grammar: "~ことが~です",
        explanation: "Likes/dislikes doing~",
        example: "読書することが好きです",
      ...
      },
      {
        ...
        explanation: "When~/if~",
        example: "天気の日きは散步します",
        exampleTranslation: "When the weather is good, I walk",
      },
      {
        grammar: "~ために~",
        explanation: "In order to~/for~",
        example: "新年のために準備します",
        exampleTranslation: "I prepare for the new week",
      },
    ],
    comprehensionQuestions: [
      {
        id: "rq-015-1",
        question: "周末喜欢在哪里读书？",
        options: ["图书馆", "咖啡馆", "家里", "办公室"],
        correctAnswer: 1,
        explanation: "周末我喜欢去咖啡馆读书。",
      },
      {
        id: "rq-015-2",
        question: "天气好的时候会去做什么？",
        options: ["看电影", "去咖啡馆", "去公园散步", "在家打扫"],
        correctAnswer: 2,
        explanation: "天气好的时候会去公园散步。",
      },
      {
        id: "rq-015-3",
        question: "周日晚上会做什么？",
        options: ["出去玩", "睡觉", "为新一周做准备", "工作"],
        correctAnswer: 2,
        explanation: "周日晚上会为新的一周做准备。",
      },
    ],
    jlptLevel: "N5",
...
These cultures are deeply loved by people around the world.`,
    vocabulary: [
      ...
      { word: "柔道", reading: "じゅうどう", meaning: "judo", partOfSpeech: "noun" },
      {
        word: "和服",
        reading: "わふく",
        meaning: "Japanese clothing/kimono",
        partOfSpeech: "noun",
      },
    ...
    grammarPoints: [
      {
        grammar: "~非常有~",
        explanation: "Very much has the characteristic of~",
        example: "非常有特色",
        exampleTranslation: "Very distinctive",
      },
      {
        grammar: "~体现了~",
        explanation: "Embodies~/represents~",
        example: "体现了宁静致远的精神",
        exampleTranslation: "Embodies a spirit of tranquility",
      },
      {
        grammar: "~深受~喜爱",
        explanation: "Deeply loved by~",
        example: "深受世界各国人民的喜爱",
        exampleTranslation: "Deeply loved by people around the world",
      },
    ],
    comprehensionQuestions: [
      {
        id: "rq-016-1",
        question: "茶道体现了什么精神？",
        options: ["竞争", "宁静致远", "快速", "激烈"],
        correctAnswer: 1,
        explanation: "茶道体现了一种宁静致远的精神。",
      },
      {
        id: "rq-016-2",
        question: "空手道和柔道是什么？",
        options: ["舞蹈", "音乐", "传统武术", "绘画"],
        correctAnswer: 2,
        explanation: "空手道和柔道是传统的武术。",
      },
      {
        id: "rq-016-3",
        question: "这些文化被谁喜爱？",
        options: ["只有日本人", "世界各国人民", "只有亚洲人", "只有年轻人"],
        correctAnswer: 1,
        explanation: "这些文化都深受世界各国人民的喜爱。",
      },
    ],
    jlptLevel: "N5",
...
Teacher: Okay, let me explain it in detail.`,
    ...
    grammarPoints: [
      {
        grammar: "~ましたか？",
        explanation: "Past tense question",
        example: "理解しましたか",
        exampleTranslation: "Did you understand?",
      },
      {
        grammar: "~が~",
        explanation: "~but~/although~",
        example: "有个地方不太明白",
        exampleTranslation: "There's one part I don't quite understand",
      },
      {
        grammar: "~を~",
        explanation: "Direct object marker",
        example: "手を起こげてください",
    ...
    comprehensionQuestions: [
      {
        id: "rq-017-1",
        question: "老师问大家什么？",
        options: ["回家了", "理解了吗", "吃饭了吗", "睡觉了吗"],
        correctAnswer: 1,
        explanation: "今天的课文大家理解了吗？",
      },
      {
        id: "rq-017-2",
        question: "学生对老师的回答是什么？",
        options: ["都明白了", "有个地方不太明白", "完全不懂", "没有问题"],
        correctAnswer: 1,
        explanation: "老师，有个地方不太明白。",
      },
      {
        id: "rq-017-3",
        question: "学生说哪部分难？",
    ...
    comprehensionQuestions: [
      {
        ...
        options: ["银行", "学校", "车站", "医院"],
        correctAnswer: 2,
        explanation: "A：すみません、駅はどこですか？",
      },
      {
        id: "rq-018-2",
        question: "应该在哪里转弯？",
        options: ["第一个路口", "第二个路口", "第三个路口", "不用转弯"],
        correctAnswer: 1,
        explanation: "二番目の交差点で右に曲がってください。",
      },
      {
        id: "rq-018-3",
        question: "车站在银行的哪一边？",
...
A: It has been changed to 3 PM in the afternoon.`,
    vocabulary: [
      ...
      { word: "お宅", reading: "おたく", meaning: "your home/residence", partOfSpeech: "noun" },
      {
        word: "申す",
        reading: "もうす",
        meaning: "to say/humble form of 言う",
        partOfSpeech: "verb",
      },
    ...
    grammarPoints: [
      {
        grammar: "~ですが",
        explanation: "This is~ (polite self-introduction on phone)",
        example: "田中ですが",
        exampleTranslation: "This is Tanaka",
      },
      {
        grammar: "~と申しますが",
        explanation: "I am~ (humble)",
        example: "山本さんと申しますが",
        exampleTranslation: "This is Yamamoto speaking",
      },
      {
        grammar: "~ようになりました",
        explanation: "Has become~/changed to~",
        example: "三時に変更になりました",
        exampleTranslation: "It has been changed to 3 PM",
      },
    ],
    comprehensionQuestions: [
      {
        id: "rq-019-1",
        question: "打电话的人是谁？",
        options: ["田中", "山本", "不知道", "老师"],
        correctAnswer: 1,
        explanation: "山本さんと申しますが。",
      },
      {
        id: "rq-019-2",
        question: "什么改变了？",
        options: ["日期", "时间", "明天的方向", "地点"],
        correctAnswer: 1,
        explanation: "明日の方向が変わりました。(Schedule changed)",
      },
      {
        id: "rq-019-3",
        question: "改成几点？",
    ...
    grammarPoints: [
      {
        ...
        example: "全国に雨",
        exampleTranslation: "Rain across the country",
      },
      {
        grammar: "~が~",
        explanation: "~subject marker",
        example: "股价小幅上涨",
        exampleTranslation: "Stock prices rose slightly",
      },
      {
        grammar: "~赢了",
        explanation: "~won",
        example: "日本队赢了比赛",
        exampleTranslation: "Japan team won the match",
      },
    ],
    comprehensionQuestions: [
      {
      ...
      },
      {
        id: "rq-020-2",
        question: "交通方面有什么问题？",
        options: ["堵车", "新干线出现延误", "飞机取消", "没有特别问题"],
        correctAnswer: 1,
        explanation: "新干线出现延误。",
      },
      {
        id: "rq-020-3",
        question: "体育新闻报道了什么？",
        options: ["日本队输了", "日本队赢了", "比赛取消", "没有体育新闻"],
        correctAnswer: 1,
        explanation: "日本队赢了比赛。",
      },
    ],
