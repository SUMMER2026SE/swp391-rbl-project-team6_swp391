...
export const mockClasses: DetailedClassInfo[] = [
  ...
  {
    id: "class-6",
    name: "N4 Advanced - Class B",
    teacher: "Akira Yamamoto",
    teacherAvatarInitials: "AY",
    level: "N4",
    members: 22,
    assignmentCount: 12,
    unfinishedCount: 2,
    ...
    weakPoints: {
      listening: ["Complex patterns"],
      grammar: ["Conditional forms"],
      vocabularyCount: 20,
    },
    classmates: [
      { name: "Hiro Suzuki", avatar: "H" },
  ...
  {
    id: "class-7",
    name: "N3 Intermediate - Class A",
    teacher: "Mika Watanabe",
    teacherAvatarInitials: "MW",
    level: "N3",
    members: 18,
    assignmentCount: 10,
    unfinishedCount: 1,
    ...
    weakPoints: {
      listening: ["Fast speech"],
      grammar: ["Complex sentences"],
      vocabularyCount: 25,
    },
    classmates: [
      { name: "Takeshi Ito", avatar: "T" },
  ...
  {
    id: "class-8",
    name: "N2 Upper Intermediate - Class A",
    teacher: "Kenji Nakamura",
    teacherAvatarInitials: "KN",
    level: "N2",
    members: 15,
    assignmentCount: 8,
    unfinishedCount: 1,
    ...
    weakPoints: {
      listening: ["Native speed"],
      grammar: ["Keigo"],
      vocabularyCount: 30,
    },
    classmates: [
      { name: "Aiko Tanaka", avatar: "A" },
  ...
  {
    id: "class-9",
    name: "N1 Advanced - Class A",
    teacher: "Yuki Kobayashi",
    teacherAvatarInitials: "YK",
    level: "N1",
    members: 12,
    assignmentCount: 6,
    unfinishedCount: 0,
    ...
    weakPoints: {
      listening: ["Academic discourse"],
      grammar: ["Complex keigo"],
      vocabularyCount: 40,
    },
    classmates: [
      { name: "Mei Yoshida", avatar: "M" },
