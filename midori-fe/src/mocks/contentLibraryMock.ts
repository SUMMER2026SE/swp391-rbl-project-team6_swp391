    ...
    items: [
      {
        ...
        word: "たべる",
        kanji: "食べる",
        meaningVietnamese: "Ăn",
        meaningJapanese: "食べます (tabemasu)",
      ...
      },
      {
        ...
        word: "のむ",
        kanji: "飲む",
        meaningVietnamese: "Uống",
        meaningJapanese: "飲みます (nomimasu)",
        exampleSentence: "水を飲みます。",
        audioUrl: "/audio/nomu.mp3",
      },
      {
        id: "v-n5-01-03",
        word: "いく",
        ...
        meaningJapanese: "行きます (ikimasu)",
        exampleSentence: "学校へ行きます。",
        audioUrl: "/audio/iku.mp3",
      },
      {
        id: "v-n5-01-04",
        word: "くる",
        kanji: "来る",
        meaningVietnamese: "Đến",
        meaningJapanese: "来ます (kimasu)",
        exampleSentence: "友達が来ます。",
        audioUrl: "/audio/kuru.mp3",
      },
      {
        id: "v-n5-01-05",
        word: "みる",
        kanji: "見る",
        meaningVietnamese: "Xem",
        meaningJapanese: "見ます (mimasu)",
        exampleSentence: "映画を見ます。",
        audioUrl: "/audio/miru.mp3",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        word: "きく",
        kanji: "聞く",
        meaningVietnamese: "Nghe/Hỏi",
        meaningJapanese: "聞きます (kikimasu)",
        exampleSentence: "音楽を聞きます。",
        audioUrl: "/audio/kiku.mp3",
      },
      {
        id: "v-n5-02-02",
        word: "よむ",
        kanji: "読む",
        meaningVietnamese: "Đọc",
        meaningJapanese: "読みます (yomimasu)",
        exampleSentence: "本を読みます。",
        audioUrl: "/audio/yomu.mp3",
      },
      {
        id: "v-n5-02-03",
        word: "かく",
        kanji: "書く",
        meaningVietnamese: "Viết",
        meaningJapanese: "書きます (kakimasu)",
        exampleSentence: "手紙を書きます。",
        audioUrl: "/audio/kaku.mp3",
      },
      {
        id: "v-n5-02-04",
        word: "はなす",
        kanji: "話す",
        meaningVietnamese: "Nói",
        meaningJapanese: "話します (hanashimasu)",
        exampleSentence: "日本語を話します。",
        audioUrl: "/audio/hanasu.mp3",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        word: "がっこう",
        kanji: "学校",
        meaningVietnamese: "Trường học",
        meaningJapanese: "がっこう (gakkou)",
        exampleSentence: "学校へ行きます。",
      ...
      },
      {
        ...
        word: "ひと",
        kanji: "人",
        meaningVietnamese: "Người",
        meaningJapanese: "ひと (hito)",
        exampleSentence: "人は多いです。",
        audioUrl: "/audio/hito.mp3",
      },
      {
        id: "v-n5-03-03",
        word: "みず",
        kanji: "水",
        meaningVietnamese: "Nước",
        meaningJapanese: "みず (mizu)",
    ...
    items: [
      {
        id: "g-n5-01-01",
        grammarPoint: "ます形",
        meaningVietnamese: "Thì hiện tại/tương lai, lịch sự",
        meaningJapanese: "Động từ cách lịch sự",
        explanation:
          "Đây là cách nói lịch sự trong tiếng Nhật. Được dùng trong giao tiếp hàng ngày.",
        exampleSentence: "私は朝ご飯を食べます。",
        notes: "Động từ cách ます được tạo bằng cách bỏ ます từ động từ thể ます và thêm ます",
      },
      {
        id: "g-n5-01-02",
        grammarPoint: "ません",
        meaningVietnamese: "Phủ định thì hiện tại/tương lai",
        meaningJapanese: "Phủ định cách lịch sự",
        explanation: "Dùng để phủ định một hành động trong tương lai hoặc hiện tại.",
        exampleSentence: "私は今日学校へ行きません。",
        notes: "Đổi ます → ません",
      },
      {
        id: "g-n5-01-03",
        grammarPoint: "ました",
        meaningVietnamese: "Thì quá khứ",
        meaningJapanese: "Quá khứ cách lịch sự",
        explanation: "Dùng để diễn tả một hành động đã xảy ra trong quá khứ.",
        exampleSentence: "昨日、映画を見ました。",
        notes: "Đổi ます → ました",
      },
    ],
  },
    ...
    items: [
      {
        ...
        meaningJapanese: "Câu khẳng định",
        explanation: "Dùng để khẳng định một sự vật hoặc đặc điểm.",
        exampleSentence: "私は学生です。",
        notes: "です dùng sau danh từ để tạo thành câu",
      },
      {
        id: "g-n5-02-02",
        grammarPoint: "〜ではありません",
        meaningVietnamese: "Không phải là...",
        meaningJapanese: "Câu phủ định",
        explanation: "Dùng để phủ định một sự vật hoặc đặc điểm.",
        exampleSentence: "私は先生ではありません。",
        notes: "ではありません = ではない + す",
      },
    ],
  },
  {
    ...
    items: [
      {
        id: "g-n5-03-01",
        grammarPoint: "〜か",
        meaningVietnamese: "Câu hỏi Yes/No",
        meaningJapanese: "Trợ từ nghi vấn",
        explanation: "Thêm か vào cuối câu để biến câu khẳng định thành câu hỏi.",
        exampleSentence: "あなたは学生ですか。",
        notes: "Trả lời: はい、そうです。/ いいえ、違います。",
      },
    ],
  },
];
    ...
    items: [
      {
        ...
        transcriptJapanese:
          "店員：いらっしゃいませ。田中：すみません、コーヒーをください。店員：はい、わかりました。田中：これください。",
        translationVietnamese:
          "Nhân viên: Chào mừng quý khách. Tanaka: Xin lỗi, cho tôi một ly cà phê. Nhân viên: Vâng, tôi hiểu rồi. Tanaka: Cho tôi cái này.",
        questions: [
          {
            id: "lq-n5-01-01",
            question: "田中さんは何を注文しましたか？",
            options: ["お茶", "コーヒー", "みず", "ジュース"],
            correctAnswer: 1,
          },
        ],
      },
    ...
    items: [
      {
        ...
        transcriptJapanese:
          "A：すみません、ぎんこうはどこですか。B：あそこです。A：ありがとうございます。B：どういたしまして。",
        translationVietnamese:
          "A: Xin lỗi, ngân hàng ở đâu? B: Ở đằng kia. A: Cảm ơn. B: Không có gì.",
        questions: [
          {
            id: "lq-n5-02-01",
            question: "ぎんこうはどこですか？",
...
const shadowingItemsN5: ShadowingItem[] = [
  {
    ...
    transcriptJapanese:
      "はじめまして。田中です。にほんから来ました。にほんごをべんきょうしています。よろしくおねがいします。",
    translationVietnamese:
      "Rất vui được gặp bạn. Tôi là Tanaka. Tôi đến từ Nhật Bản. Tôi đang học tiếng Nhật. Rất hân hạnh được làm quen.",
    segments: [
      {
        id: "seg-n5-01-01",
        startTime: 0,
      ...
      },
      {
        ...
        endTime: 10,
        japaneseText: "田中です。",
        vietnameseTranslation: "Tôi là Tanaka.",
      },
      {
        id: "seg-n5-01-03",
        startTime: 10,
        endTime: 16,
        japaneseText: "にほんから来ました。",
        vietnameseTranslation: "Tôi đến từ Nhật Bản.",
      },
      {
        id: "seg-n5-01-04",
        startTime: 16,
        endTime: 22,
        japaneseText: "にほんごをべんきょうしています。",
      ...
      },
      {
        ...
        startTime: 22,
        endTime: 28,
        japaneseText: "よろしくおねがいします。",
        vietnameseTranslation: "Rất hân hạnh được làm quen.",
      },
    ],
  },
  {
    ...
    segments: [
      {
        ...
        vietnameseTranslation: "Xin lỗi, ga tàu ở đâu?",
      },
      {
        id: "seg-n5-02-02",
        startTime: 5,
        endTime: 9,
        japaneseText: "あそこです。",
        vietnameseTranslation: "Ở đằng kia.",
      },
      {
        id: "seg-n5-02-03",
        startTime: 9,
    ...
    segments: [
      {
        ...
        vietnameseTranslation: "Cái này bao nhiêu tiền?",
      },
      {
        id: "seg-n5-03-02",
        startTime: 5,
        endTime: 9,
        japaneseText: "500えんです。",
        vietnameseTranslation: "500 yên.",
      },
      {
        id: "seg-n5-03-03",
        startTime: 9,
        endTime: 14,
        japaneseText: "じゃ、これをください。",
        vietnameseTranslation: "Vậy cho tôi cái này.",
      },
    ],
  },
];
...
const vocabularyLessonsN4: VocabularyLesson[] = [
  {
    id: "vocab-n4-01",
    lessonNumber: 1,
    title: "Bài 1 - Từ vựng về công việc",
    items: [
      {
        id: "v-n4-01-01",
        word: "しごと",
        kanji: "仕事",
        meaningVietnamese: "Công việc",
        meaningJapanese: "しごと (shigoto)",
        exampleSentence: "今日は仕事がありません。",
        audioUrl: "/audio/shigoto.mp3",
      },
      {
        id: "v-n4-01-02",
        word: "かいもの",
        kanji: "買い物",
        meaningVietnamese: "Mua sắm",
        meaningJapanese: "かいもの (kaimono)",
        exampleSentence: "週末に買い物に行きます。",
        audioUrl: "/audio/kaimono.mp3",
      },
    ],
  },
  {
    id: "vocab-n4-02",
    lessonNumber: 2,
    title: "Bài 2 - Từ vựng về thời gian",
    items: [
      {
        id: "v-n4-02-01",
        word: "きのう",
        kanji: "昨日",
        meaningVietnamese: "Ngày hôm qua",
        meaningJapanese: "きのう (kinou)",
        exampleSentence: "きのう映画を見ました。",
        audioUrl: "/audio/kinou.mp3",
      },
    ],
  },
  {
    id: "vocab-n4-03",
    lessonNumber: 3,
    title: "Bài 3 - Từ vựng về địa điểm",
    items: [
      {
        id: "v-n4-03-01",
        word: "びょういん",
        kanji: "病院",
        meaningVietnamese: "Bệnh viện",
        meaningJapanese: "びょういん (byouin)",
        exampleSentence: "びょういんへ行きました。",
        audioUrl: "/audio/byouin.mp3",
      },
    ],
  },
];
...
const grammarLessonsN4: GrammarLesson[] = [
  {
    id: "gram-n4-01",
    lessonNumber: 1,
    title: "Bài 1 - Thì quá khứ",
    items: [
      {
        id: "g-n4-01-01",
        grammarPoint: "〜ました",
        meaningVietnamese: "Đã làm gì",
        meaningJapanese: "Quá khứ cách lịch sự",
        explanation: "Dùng để diễn tả hành động đã xảy ra trong quá khứ.",
        exampleSentence: "昨日、日本食を食べました。",
        notes: "Đổi ます → ました",
      },
    ],
  },
    ...
    items: [
      {
        id: "g-n4-02-01",
        grammarPoint: "〜たいです",
        meaningVietnamese: "Muốn làm gì",
        meaningJapanese: "Nguyện vọng",
        explanation: "Dùng để diễn tả mong muốn, nguyện vọng của bản thân.",
    ...
    items: [
      {
        id: "g-n4-03-01",
        grammarPoint: "〜つもりです",
        meaningVietnamese: "Dự định làm gì",
        meaningJapanese: "Kế hoạch",
        explanation: "Dùng để diễn tả kế hoạch, dự định trong tương lai.",
        exampleSentence: "来週、旅行に行くつもりです。",
        notes: "Động từ thể ます + つもりです",
      },
    ],
  },
];
...
const listeningLessonsN4: ListeningLesson[] = [
  {
    id: "list-n4-01",
    lessonNumber: 1,
    title: "Bài 1 - Kế hoạch cuối tuần",
    items: [
      {
        id: "list-n4-01-01",
        title: "Kế hoạch cuối tuần",
        audioUrl: "/audio/weekend.mp3",
        transcriptJapanese:
          "今度の週末、何をしますか。びょういんへ行きます。でも、午前中はともだちとコーヒーを飲みます。",
        translationVietnamese:
          "Cuối tuần này làm gì? Tôi đi bệnh viện. Nhưng buổi sáng tôi uống cà phê với bạn.",
        questions: [
          {
            id: "lq-n4-01-01",
            question: "周末做什么？",
            options: ["去医院", "去学校", "去公司", "留在家"],
            correctAnswer: 0,
          },
        ],
      },
    ...
    items: [
      {
        ...
        transcriptJapanese: "今日の天気はどうですか。今日は晴れです。明日も晴れです。",
        translationVietnamese: "Hôm nay thời tiết thế nào? Hôm nay trời nắng. Ngày mai cũng nắng.",
        questions: [],
      },
    ],
  },
...
const shadowingItemsN4: ShadowingItem[] = [
  {
    ...
    transcriptJapanese:
      "今度の休み、何をするつもりですか。旅行に行くつもりです。どこへ行きますか。北海道へ行くつもりです。",
    translationVietnamese:
      "Kỳ nghỉ tới có kế hoạch gì? Tôi định đi du lịch. Đi đâu? Tôi định đi Hokkaido.",
    segments: [
      {
        id: "seg-n4-01-01",
        startTime: 0,
        endTime: 6,
        japaneseText: "今度の休み、何をするつもりですか。",
        vietnameseTranslation: "Kỳ nghỉ tới có kế hoạch gì?",
      },
      {
        id: "seg-n4-01-02",
        startTime: 6,
        endTime: 11,
        japaneseText: "旅行に行くつもりです。",
        vietnameseTranslation: "Tôi định đi du lịch.",
      },
      {
        id: "seg-n4-01-03",
        startTime: 11,
        endTime: 15,
        japaneseText: "どこへ行きますか。",
        vietnameseTranslation: "Đi đâu?",
      },
      {
        id: "seg-n4-01-04",
        startTime: 15,
        endTime: 21,
        japaneseText: "北海道へ行くつもりです。",
        vietnameseTranslation: "Tôi định đi Hokkaido.",
      },
    ],
  },
];
    ...
    items: [
      {
        ...
        meaningJapanese: "けいけん (keiken)",
        exampleSentence: "日本での経験を生かしたい。",
        audioUrl: "/audio/keiken.mp3",
      },
    ],
  },
];
    ...
    items: [
      {
        id: "g-n3-01-01",
        grammarPoint: "〜ために",
        meaningVietnamese: "Để làm gì, nhằm mục đích",
        meaningJapanese: "Mục đích",
        explanation: "Dùng để diễn tả mục đích, ý đồ.",
        exampleSentence: "合格するために、毎日勉強しています。",
        notes: "Danh từ + のために / Động từ thể ます - ます + ために",
      },
    ],
  },
];
    ...
    items: [
      {
        id: "list-n3-01-01",
        title: "Nghe N3",
        audioUrl: "/audio/n3-01.mp3",
        transcriptJapanese: "最近、日本の若者の間での転職が増えています。",
        translationVietnamese:
          "Gần đây, việc chuyển công việc giữa người trẻ Nhật Bản đang tăng lên.",
        questions: [],
      },
    ],
  },
...
const vocabularyLessonsN2: VocabularyLesson[] = [
  {
    id: "vocab-n2-01",
    lessonNumber: 1,
    title: "Bài 1 - Từ vựng N2",
    items: [
      {
        id: "v-n2-01-01",
        word: "改革",
        kanji: "改革",
        meaningVietnamese: "Cải cách",
        meaningJapanese: "かいかく (kaikaku)",
        exampleSentence: "教育改革が必要です。",
        audioUrl: "/audio/kaikaku.mp3",
      },
    ],
  },
];
    ...
    items: [
      {
        id: "g-n2-01-01",
        grammarPoint: "〜ものの",
        meaningVietnamese: "Mặc dù...nhưng...",
        meaningJapanese: "Nhượng bộ",
        explanation: "Diễn tả nghĩa nhượng bộ, dù có điều gì đó nhưng...",
        exampleSentence: "聞いたものの、覚えていない。",
        notes: "Thể thông thường + ものの",
      },
    ],
  },
];
    ...
    items: [
      {
        id: "list-n2-01-01",
        title: "Nghe N2",
        audioUrl: "/audio/n2-01.mp3",
        transcriptJapanese: "最近の调查显示，年轻人对工作的价值观正在发生变化。",
        translationVietnamese:
          "Khảo sát gần đây cho thấy, giá trị về công việc của người trẻ đang thay đổi.",
        questions: [],
      },
    ],
  },
...
const shadowingItemsN2: ShadowingItem[] = [
  {
    ...
    translationVietnamese:
      "Chủ đề hôm nay là về 'Những thách thức và biện pháp đối với xã hội già hóa'.",
    segments: [],
  },
];
...
const vocabularyLessonsN1: VocabularyLesson[] = [
  {
    id: "vocab-n1-01",
    lessonNumber: 1,
    title: "Bài 1 - Từ vựng N1",
    items: [
      {
        id: "v-n1-01-01",
        word: "多様性",
        kanji: "多様性",
        meaningVietnamese: "Tính đa dạng",
        meaningJapanese: "たようせい (tayousei)",
        exampleSentence: "社会の多様性を尊重すべきです。",
        audioUrl: "/audio/tayousei.mp3",
      },
    ],
  },
];
    ...
    items: [
      {
        ...
        meaningVietnamese: "Không sợ hãi, không nao núng trước",
        meaningJapanese: "Bất chấp",
        explanation: "Diễn tả ý chí không bị khuất phục bởi khó khăn, thử thách.",
        exampleSentence: "困難をものともせず前進する。",
        notes: "Danh từ + をものともせず",
      },
    ],
  },
];
...
const readingLessonsN1: ReadingLesson[] = [
  {
    id: "read-n1-01",
    lessonNumber: 1,
    title: "Bài 1 - Bài đọc N1",
    items: [
      {
        id: "read-n1-01-01",
        title: "Bài đọc N1",
        passage:
          "グローバル化が進む現代において、異文化間の理解と交流は重要性を増している。しかし、表面的接触の増加が必ずしも相互理解の深化につながるわけではない。",
        translationVietnamese:
          "Trong thời đại toàn cầu hóa ngày càng sâu rộng, sự hiểu biết và giao lưu giữa các nền văn hóa khác nhau đang ngày càng quan trọng. Tuy nhiên, việc tăng tiếp xúc bề mặt không nhất thiết dẫn đến sự hiểu biết sâu sắc hơn lẫn nhau.",
        questions: [],
      },
    ],
  },
    ...
    items: [
      {
        id: "list-n1-01-01",
        title: "Nghe N1",
        audioUrl: "/audio/n1-01.mp3",
        transcriptJapanese: "现代社会においてコミュニケーションの形は大きく変わりつつある。",
        translationVietnamese: "Trong xã hội hiện đại, hình thức giao tiếp đang thay đổi đáng kể.",
        questions: [],
      },
    ],
  },
...
const shadowingItemsN1: ShadowingItem[] = [
  {
    ...
    transcriptJapanese:
      "本日の演讲は、人工知能の进化が人类社会に与える影响について検討いたします。",
    translationVietnamese:
      "Bài giảng hôm nay sẽ xem xét ảnh hưởng của trí tuệ nhân tạo đối với xã hội loài người.",
    segments: [],
  },
];
...
export const contentLibraryData: Record<JLPTLevel, LevelContent> = {
  N5: {
    level: "N5",
    skills: {
      vocabulary: vocabularyLessonsN5,
      grammar: grammarLessonsN5,
      reading: readingLessonsN5,
      listening: listeningLessonsN5,
      shadowing: shadowingItemsN5,
    },
  },
  N4: {
    level: "N4",
    skills: {
      vocabulary: vocabularyLessonsN4,
      grammar: grammarLessonsN4,
      reading: readingLessonsN4,
      listening: listeningLessonsN4,
      shadowing: shadowingItemsN4,
    },
  },
  N3: {
    level: "N3",
    skills: {
      vocabulary: vocabularyLessonsN3,
      grammar: grammarLessonsN3,
      reading: readingLessonsN3,
      listening: listeningLessonsN3,
      shadowing: shadowingItemsN3,
    },
  },
  N2: {
    level: "N2",
    skills: {
      vocabulary: vocabularyLessonsN2,
      grammar: grammarLessonsN2,
      reading: readingLessonsN2,
      listening: listeningLessonsN2,
      shadowing: shadowingItemsN2,
    },
  },
  N1: {
    level: "N1",
    skills: {
      vocabulary: vocabularyLessonsN1,
      grammar: grammarLessonsN1,
      reading: readingLessonsN1,
      listening: listeningLessonsN1,
      shadowing: shadowingItemsN1,
    },
  },
};
...
export function getContentStats(level: JLPTLevel): ContentStats {
  ...
  if (!content)
    return { total: 0, vocabulary: 0, grammar: 0, reading: 0, listening: 0, shadowing: 0 };
  ...
  return {
    total: vocabulary + grammar + reading + listening + shadowing,
    vocabulary,
    grammar,
    reading,
    listening,
  ...
  if (!Array.isArray(items)) {
    ...
    if (skillName === "vocabulary")
      items.forEach((item, i) =>
        errors.push(...validateVocabularyItem(item, `${path}.items[${i}]`)),
      );
    else if (skillName === "grammar")
      items.forEach((item, i) => errors.push(...validateGrammarItem(item, `${path}.items[${i}]`)));
    else if (skillName === "reading")
      items.forEach((item, i) => errors.push(...validateReadingItem(item, `${path}.items[${i}]`)));
    else if (skillName === "listening")
      items.forEach((item, i) =>
        errors.push(...validateListeningItem(item, `${path}.items[${i}]`)),
      );
  }
...
export function validateContentLibraryData(): ValidationResult {
  ...
  for (const level of levels) {
    const content = contentLibraryData[level];
    if (!content) {
      errors.push(`Missing level: ${level}`);
      continue;
    }
    if (!content.skills) {
      errors.push(`${level}: missing skills`);
      continue;
    }
    ...
    for (const skill of skills) {
      ...
      if (!Array.isArray(skillData)) {
        errors.push(`${level}.${skill}: is not an array`);
        continue;
      }
      ...
      if (skill === "shadowing") {
        (skillData as ShadowingItem[]).forEach((item, i) => {
          ...
          if (Array.isArray(item.segments)) {
            item.segments.forEach((seg, j) =>
              errors.push(
                ...validateShadowingSegment(seg, `${level}.shadowing[${i}].segments[${j}]`),
              ),
            );
          }
        });
        ...
        (
          skillData as (VocabularyLesson | GrammarLesson | ReadingLesson | ListeningLesson)[]
        ).forEach((lesson, i) => {
...
export function updateVocabularyLesson(
  level: JLPTLevel,
  lessonId: string,
  updates: Partial<VocabularyLesson>,
): void {
...
export function deleteVocabularyLesson(level: JLPTLevel, lessonId: string): void {
  contentStore[level].skills.vocabulary = contentStore[level].skills.vocabulary.filter(
    (l) => l.id !== lessonId,
  );
  notifyListeners();
}
...
export function updateGrammarLesson(
  level: JLPTLevel,
  lessonId: string,
  updates: Partial<GrammarLesson>,
): void {
...
export function deleteGrammarLesson(level: JLPTLevel, lessonId: string): void {
  contentStore[level].skills.grammar = contentStore[level].skills.grammar.filter(
    (l) => l.id !== lessonId,
  );
  notifyListeners();
}
...
export function updateReadingLesson(
  level: JLPTLevel,
  lessonId: string,
  updates: Partial<ReadingLesson>,
): void {
...
export function deleteReadingLesson(level: JLPTLevel, lessonId: string): void {
  contentStore[level].skills.reading = contentStore[level].skills.reading.filter(
    (l) => l.id !== lessonId,
  );
  notifyListeners();
}
...
export function addReadingQuestion(
  level: JLPTLevel,
  lessonId: string,
  itemId: string,
...
export function updateReadingQuestion(
  level: JLPTLevel,
  lessonId: string,
  itemId: string,
  questionId: string,
  updates: Partial<ReadingQuestion>,
): void {
  const lesson = contentStore[level].skills.reading.find((l) => l.id === lessonId);
  if (lesson) {
    const item = lesson.items.find((i) => i.id === itemId);
...
export function deleteReadingQuestion(
  level: JLPTLevel,
  lessonId: string,
  itemId: string,
  questionId: string,
...
export function updateListeningLesson(
  level: JLPTLevel,
  lessonId: string,
  updates: Partial<ListeningLesson>,
): void {
...
export function deleteListeningLesson(level: JLPTLevel, lessonId: string): void {
  contentStore[level].skills.listening = contentStore[level].skills.listening.filter(
    (l) => l.id !== lessonId,
  );
  notifyListeners();
}
...
export function updateListeningItem(
  level: JLPTLevel,
  lessonId: string,
  itemId: string,
  updates: Partial<ListeningItem>,
): void {
  const lesson = contentStore[level].skills.listening.find((l) => l.id === lessonId);
  if (lesson) {
    const item = lesson.items.find((i) => i.id === itemId);
...
export function addListeningQuestion(
  level: JLPTLevel,
  lessonId: string,
  itemId: string,
...
export function updateListeningQuestion(
  ...
  itemId: string,
  questionId: string,
  updates: Partial<ListeningQuestion>,
): void {
  const lesson = contentStore[level].skills.listening.find((l) => l.id === lessonId);
  if (lesson) {
    const item = lesson.items.find((i) => i.id === itemId);
...
export function deleteListeningQuestion(
  level: JLPTLevel,
  lessonId: string,
  itemId: string,
  questionId: string,
...
export function updateShadowingItem(
  level: JLPTLevel,
  itemId: string,
  updates: Partial<ShadowingItem>,
): void {
...
export function deleteShadowingItem(level: JLPTLevel, itemId: string): void {
  contentStore[level].skills.shadowing = contentStore[level].skills.shadowing.filter(
    (i) => i.id !== itemId,
  );
  notifyListeners();
}

export function addShadowingSegment(
  level: JLPTLevel,
  itemId: string,
...
export function updateShadowingSegment(
  level: JLPTLevel,
  itemId: string,
  segmentId: string,
  updates: Partial<ShadowingSegment>,
): void {
  const item = contentStore[level].skills.shadowing.find((i) => i.id === itemId);
  if (item) {
