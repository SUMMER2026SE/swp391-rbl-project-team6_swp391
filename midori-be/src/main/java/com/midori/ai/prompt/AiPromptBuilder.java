...
public final class AiPromptBuilder {
    ...
    // ============================================================
    // SHADOWING/TRANSLATION PROMPTS
    // ============================================================

    /**
     * Prompt for Japanese to Vietnamese translation (used in shadowing service).
     */
    public static String getShadowingTranslationPrompt() {
        return """
                You are a professional Japanese translator.

                Translate each Japanese sentence into natural Vietnamese.
    ...
    /**
     * Build a translation request with input sentences.
     */
    public static String buildTranslationRequest(String[] sentences) {
        StringBuilder sb = new StringBuilder();
        sb.append(getShadowingTranslationPrompt());
        sb.append("\nInput sentences:\n");
    ...
    /**
     * Build a translation request with ALL sentences in ONE prompt.
     * This optimized version includes indexed sentences for reliable parsing.
     */
    public static String buildTranslationRequestAll(String[] sentences) {
        StringBuilder sb = new StringBuilder();
        sb.append(getShadowingTranslationPrompt());
        sb.append("\n");
